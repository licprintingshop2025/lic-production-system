    ...
    return NextResponse.json(
      {
        ...
        error:
          "Failed to load BIR printing orders.",
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json(
        {
          error:
            "Trello card created, but failed to save to Google Sheet",
    ...
    return NextResponse.json(
      {
        error:
          "Server error while creating ATP record",
